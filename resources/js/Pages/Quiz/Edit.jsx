                            ...
                            <div key={qIndex} className="mb-8">
                                ...
                                <div className="grid grid-cols-2 gap-6">
                                    {question.answers.map((answer, aIndex) => (
                                        <input
                                            key={aIndex}
                                            className={`bg-gray-100 border-2 focus:ring-gray-200 focus:border-gray-200 rounded-lg p-6 m-2 ${answer.is_correct ? 'focus:ring-green-500 focus:border-green-500 border-green-500' : 'border-gray-200'}`}
